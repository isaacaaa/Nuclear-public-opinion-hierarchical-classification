...
def train(args, train_dataset, model, tokenizer):
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            loss ,train_logit= outputs[:2]  # model outputs are always tuple in transformers (see doc)
            
            loss1,train_logit1 = outputs1[:2]
            
            loss2 ,train_logit2= outputs2[:2]
...
def main():
    ...
    parser.add_argument(
        "--num_train_epochs", default=25.0, type=float, help="Total number of training epochs to perform."
    )
    parser.add_argument(
        "--max_steps",
        default=-1,
